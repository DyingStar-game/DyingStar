...
class_name RemotePlayerControllability
...
func physics_process(_delta: float) -> void:
	if OS.has_feature("dedicated_server"):
		if new_input_from_server:
			...
			entity.global_rotation = input_from_server["rotation"]
		...
		entity.emit_signal("hs_server_move", entity.client_uuid, entity.position, entity.global_rotation, null, entity.is_parented)
